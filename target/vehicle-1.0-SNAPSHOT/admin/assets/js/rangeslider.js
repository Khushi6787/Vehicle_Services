(function () {
  ...
  /* Rangeslider 2 */
  var sliders = document.querySelectorAll('.slider2');
  rangesliderJs.create(sliders)

  /* Rangeslider 3 */
  var sliderEl = document.querySelector('.slider3');
  ...
  var slider1 = document.getElementById('lockslider1');
  var slider2 = document.getElementById('lockslider2');

  var lockButton = document.getElementById('lockbutton');
  var slider1Value = document.getElementById('lockslider1-span');
  var slider2Value = document.getElementById('lockslider2-span');
