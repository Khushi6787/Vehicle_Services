...
var spark4 = new ApexCharts(document.querySelector("#glm-chart"), spark4);
spark4.render();

/* End:: Main cards charts */
function crypto() {
  spark1.updateOptions({
    colors: ["rgba(" + myVarVal + ",0.7)"],
  });
}
function crypto2() {
...
var spark5 = new ApexCharts(
  document.querySelector("#bitcoin-price-graph"),
  spark5
);
spark5.render();
